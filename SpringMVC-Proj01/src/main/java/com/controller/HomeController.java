...
public class HomeController {
	...
	public String doRegister(RegisterDTO register,HttpSession session) {
	...
	public String doLogin(LoginDTO data,HttpSession session) {
		...
		if(data.getEmail().equalsIgnoreCase(dto.getEmail()) && data.getPassword().equalsIgnoreCase(dto.getPassword())) {
